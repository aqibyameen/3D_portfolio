...
<div className="w-full flex">
  ...
  >
    ...
    through real-world examples of work. Each project is 
    briefly described with linked to code repositories and
    live demos in it. It reflects my ability to solve complex 
    problems with different technologies, and manage Projects
    effectively.
